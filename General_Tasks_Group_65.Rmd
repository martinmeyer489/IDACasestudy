...
denscomp(list(fit_nb, fit_n, fit_p), legendtext = plot.legend)
qqcomp(list(fit_nb, fit_n, fit_p), legendtext = plot.legend)
cdfcomp(list(fit_nb, fit_n, fit_p), legendtext = plot.legend)
ppcomp(list(fit_nb, fit_n, fit_p), legendtext = plot.legend)
```
